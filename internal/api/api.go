...
import (
	...
	"github.com/MessiasR/go-react-web/internal/store/pgstore"
...
func (h apiHandler) handleSubscribe(w http.ResponseWriter, r *http.Request) {
	...
	slog.Info("new client connected", "room_id", rawRoomID, "cliente_ip", r.RemoteAddr)
...
func (h apiHandler) handleGetRoomsMessages(w http.ResponseWriter, r *http.Request) {
	...
	go h.notifyClients(Message{
		King:   MessageKingMessageCreated,
		RoomID: rawRoomID,
